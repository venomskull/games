...
document.addEventListener('DOMContentLoaded', function () {
    ...
    for (let i = 0, len = squares.length; i < len; i++) {
        ...
        // squares[i].addEventListener('onclick', function() {
        //     console.log('clicked');
        // });

        squares[i].onclick = function () {
            // If below square is taken then we can use above square
            ...
            // If the below square is not taken then you cannot use above square
            else {
                alert('cant go here');
            }
        }
